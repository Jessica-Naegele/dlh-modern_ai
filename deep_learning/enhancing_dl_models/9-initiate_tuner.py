...
This function is initializing a Keras Tuner for hyperparameter
tuning. Arguments provided to this functions are tuner_type,
build_model, x and y values, seed, hyperband_iterations, max_trials)
"""
...
def initiate_tuner(
    ...
    initiating hyperparameter tuning
        ...
        - max_trials (int) max trials for RandomSearch and
            BaysianOptimization
        - objective (str) - Metric to optimize during tuning
        - overwrite (bool)
            Default True (whether to overwrite previous tuning
            project)
