...
def create_features(df):
    ...
    target_cols = [col for col in df.columns if 'No internet service' in df[col].values]
    ...
    df['TenureGroup'] = pd.cut(df['tenure'], bins=bins, labels=labels, include_lowest=False)
